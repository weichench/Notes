...
/*    std::string bagfile = "/home/slam/Dataset/V1_02_medium.bag"*/;
 
//   std::string bagfile = "/home/slam/Dataset/MH_01_easy/MH_01_easy.bag";
// double dataset_time_begain=1403636579;
// double dataset_time_end=dataset_time_begain+200;
 
//    std::string bagfile = "/home/chenchen/Dataset/MH_04_difficult/MH_04_difficult.bag";
//  double dataset_time_begain=1403638127;
// double dataset_time_end=dataset_time_begain+200;
 
 
//   std::string bagfile = "/home/slam/Dataset/MH_05_difficult/MH_05_difficult.bag";
// double dataset_time_begain=1403638540;
// double dataset_time_end=dataset_time_begain+200;
 
 
//  std::string bagfile = "/home/slam/Dataset/mynteye/mynteye_data_2.bag";
// double dataset_time_begain=1594716907;
// double dataset_time_end=dataset_time_begain+80;

/* 
 std::string bagfile = "/home/slam/Dataset/mynteye/mynteye_data_3.bag";
double dataset_time_begain=1594723263;
double dataset_time_end=dataset_time_begain+50;*/


//  std::string bagfile = "/home/slam/Dataset/mynteye/mynteye_data_4.bag";
// double dataset_time_begain=1595647361;
// double dataset_time_end=dataset_time_begain+50;

//  std::string bagfile = "/home/slam/Dataset/mynteye/mynteye_data_5.bag";
// double dataset_time_begain=1595662494+30;
// double dataset_time_end=dataset_time_begain+125;

//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data.bag";
// double dataset_time_begain=1606283625+1;
// double dataset_time_end=dataset_time_begain+125;


//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data1.bag";
// double dataset_time_begain=1606283742+1;
// double dataset_time_end=dataset_time_begain+125;

//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data2.bag";
// double dataset_time_begain=1606283970+1;
// double dataset_time_end=dataset_time_begain+125;

//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data3.bag";
// double dataset_time_begain=1606284055+1;
// double dataset_time_end=dataset_time_begain+125;

/*
 std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data6.bag";
double dataset_time_begain=1606353652+1;
double dataset_time_end=dataset_time_begain+125;*/


//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data7.bag";
// double dataset_time_begain=1606353835+1;
// double dataset_time_end=dataset_time_begain+125;


//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data8.bag";
// double dataset_time_begain=1606353943+1;
// double dataset_time_end=dataset_time_begain+125;
...
//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data9.bag";
// double dataset_time_begain=1606354544+1;
// double dataset_time_end=dataset_time_begain+125;


//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data12.bag";
// double dataset_time_begain=1606365008+1;
// double dataset_time_end=dataset_time_begain+125;


//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data13.bag";
// double dataset_time_begain=1606365159+1;
// double dataset_time_end=dataset_time_begain+125;


/*
 std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data14.bag";
double dataset_time_begain=1606365254+1;
double dataset_time_end=dataset_time_begain+125;*/

//  std::string bagfile = "/home/slam/Dataset/mynteye/corridor/mynteye_data.bag";
// double dataset_time_begain=1606358435+1;
// double dataset_time_end=dataset_time_begain+125;


//  std::string bagfile = "/home/slam/Dataset/Tum/dataset-corridor4_512_16.bag";
// // double dataset_time_begain=1594552570;
// double dataset_time_begain=1520621178;
// double dataset_time_end=dataset_time_begain+90;

 
//    std::string bagfile = "/home/chenchen/Dataset/MH_03_medium/MH_03_medium.bag";
//  double dataset_time_begain=1403637130;
// double dataset_time_end=dataset_time_begain+200;
 
//     std::string bagfile = "/home/chenchen/Dataset/MH_02_easy/MH_02_easy.bag";
//  double dataset_time_begain=1403636858;
// double dataset_time_end=dataset_time_begain+160;



//     std::string bagfile = "/home/slam/Dataset/mynteye/on_car/mynteye_data1_14_5.bag";
//  double dataset_time_begain=1610603657+1;
// double dataset_time_end=dataset_time_begain+160;




//__________________________on car
//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car/data1.bag";
//  double dataset_time_begain=1610630639+1;
// double dataset_time_end=dataset_time_begain+160;

//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/MYNTEYE_data4.bag";
//  double dataset_time_begain=1611051724+1;
// double dataset_time_end = dataset_time_begain+160;


//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/MYNTEYE_data5.bag";
//  double dataset_time_begain=1611051888+1;
// double dataset_time_end = dataset_time_begain+160;



//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/MYNTEYE_data3.bag";
//  double dataset_time_begain=1611051539+1;
// double dataset_time_end = dataset_time_begain+160;



//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/MYNTEYE_data2.bag";
//  double dataset_time_begain=1611051346+1;
// double dataset_time_end = dataset_time_begain+160;

//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/MYNTEYE_data1.bag";
//  double dataset_time_begain=1611051119+1;
// double dataset_time_end = dataset_time_begain+160;


//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/long_car.bag";
//  double dataset_time_begain=1622411385+1;
// double dataset_time_end = dataset_time_begain+260;


//  std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/turn_car.bag";
//  double dataset_time_begain=1622325675+1;
// double dataset_time_end = dataset_time_begain+260;
 std::string bagfile = "/home/slam/Dataset/mynteye/on_car_1/white_car.bag";
 double dataset_time_begain=1622410482+1;
double dataset_time_end = dataset_time_begain+260;
...
//获取时间戳小于t的所有IMU数据
bool getIMUInterval(double t1, vector<pair<double, Eigen::Vector3d>> &accVector, 
                                vector<pair<double, Eigen::Vector3d>> &gyrVector)
{
    ...
    {
        while (t1 - accBuf.front().first > 1.0/15)
        {
            accBuf.pop();
            gyrBuf.pop();
        }
...
// 		while(time0<1403715549.362142976)
	...
	getIMUInterval(header.stamp.toSec(), accVector, gyrVector);
      ...
      averAcc = averAcc/n;
      cout<<"Acc "<<averAcc.transpose()<<endl;
      Eigen::Vector3d g_cam = RIC.transpose()*averAcc;
      g_cam = g_cam/g_cam(2);
      cout<<"Acc in cam "<<g_cam.transpose()<<endl;
        frame_cnt++;
	...
	vp_g.y = g_cam(1);
	  ...
	  vanishing_point_detect(trackerData.curframe_->img, trackerData.K_[0], trackerData.curframe_->keylsd,vps,ind_cs, vp_g);
...
//判断提取出的消失点方向的夹角
{
     Eigen::Vector3d vp1, vp2, vp3;
     double angle_1, angle_2, angle_3;
     
     
     vp1 = Eigen::Vector3d(vps[0].at<float>(0,0), vps[0].at<float>(1,0), vps[0].at<float>(2,0));
     vp2 = Eigen::Vector3d(vps[1].at<float>(0,0), vps[1].at<float>(1,0), vps[1].at<float>(2,0));
     vp3 = Eigen::Vector3d(vps[2].at<float>(0,0), vps[2].at<float>(1,0), vps[2].at<float>(2,0));
      ...
      cout<<"angle between vps "<<angle_1<<" "<<angle_2<<" "<<angle_3<<endl;   
      
 if(!(angle_1>55 && angle_2>55 && angle_3>55))
  {
    cv::waitKey(1);
  }
...
//      point_uv.y = 240;
//      Point2d point_xy;
//      point_xy = trackerData.uv2xy(point_uv);
//      cout<<"point_xy: "<< point_xy.x<< " "<<point_xy.y<<endl;
//      waitKey(0);
//   }
...
//     std::string right_imagetopic = "/cam1/image_raw";
    std::string left_imagetopic =  "/mynteye/left/image_raw";
    std::string right_imagetopic = "/mynteye/right/image_raw";
    std::string imu_topic = "/mynteye/imu/data_raw";
//         std::string left_imagetopic =  "/mynteye/left_rect/image_rect";
//     std::string right_imagetopic = "/mynteye/right_rect/image_rect";
...
//        if (m.getTopic()== "/mynteye/left/image_raw" )
         if (m.getTopic()== left_imagetopic )
	 {
...
// 	  if (m.getTopic()=="/mynteye/right/image_raw") 
	  if (m.getTopic()== right_imagetopic) 
     {
   ...
   cout<<"The number of img msg is "<< img0_buf.size()<< " and  "<< img1_buf.size()<<endl;
   cout<<"The number of imu msg is "<<accBuf.size()<<" and "<< gyrBuf.size()<<endl;
