...
void Estimator::setParameter()
{
    ...
    ProjectionStructuralLine::sqrt_info = FOCAL_LENGTH / 1.4 * Matrix2d::Identity();
    ...
    distance_StructuralLine_Point::sqrt_info = (1/0.2638) * Matrix2d::Identity();
